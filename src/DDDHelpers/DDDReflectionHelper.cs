...
namespace System
{
    internal class PrivateReflectionDynamicObject : DynamicObject
    {
        ...
        private static IDictionary<string, IProperty> GetTypeProperties(Type type)
        {
            ...
            if (_propertiesOnType.TryGetValue(type, out IDictionary<string, IProperty> typeProperties))
            {
    ...
    {
        public static dynamic AsDynamic(this object o) => PrivateReflectionDynamicObject.WrapObjectIfNeeded(o);
    }
}
